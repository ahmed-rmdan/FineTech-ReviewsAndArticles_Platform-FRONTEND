...
const onsubmit:SubmitHandler<formfield>=async(data)=>{
 ...
 try{
      const res1= await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/reviews/editreview`,{
         method:'PUT',
...
throw new Error(postdata.message as string)
  ...
  console.log(formdata.get('file'))
      ...
      const res2= await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/reviews/editreviewimage?id=${review._id}`,{
         method:'PUT',
                    body:formdata
 })
