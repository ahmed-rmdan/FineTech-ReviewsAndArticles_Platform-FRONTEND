...
export async function saveing(id:string,itemid:string,kind:string){
      const res=await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/users/addsave`,{ 
                     method:'POST'    
                     , 
                    cache:'default',
...
export async function liking(id:string,itemid:string,kind:string){
      const res=await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/users/addlike`,{ 
                     method:'POST'    
                     , 
                    cache:'default',
                    headers:{'Content-Type': 'application/json'} ,
...
export async function addcomment(userid:string,itemid:string,content:string){
      const res=await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/comments/addcomment`,{ 
                     method:'POST'    
                     , 
                    headers:{'Content-Type': 'application/json'} ,
...
export async function addsubcomment(userid:string,itemid:string,content:string,commentid:string){
      const res=await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/comments/addsubcomment`,{ 
                     method:'POST'    
                     , 
                    headers:{'Content-Type': 'application/json'} ,
                    body:JSON.stringify({userid,
...
export async function likingcomment(id:string,itemid:string,kind:string){
      ...
      const res=await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/comments/addcommentlike`,{ 
                     method:'PUT'    
                     , 
                    cache:'default',
                    headers:{'Content-Type': 'application/json'} ,
...
export async function DeleteComment(id:string){
       ...
       const res=await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/comments/deletecomment`,{
        method:'PUT',
        headers:{    'Content-Type': 'application/json'},
        body:JSON.stringify({id})
       })                             
...
export async function BanUser(id:string,token:string){
       ...
       const res=await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/users/banuser`,{
        method:'PUT',
        headers:{    'Content-Type': 'application/json',
